              ...
              {dataFetched ? (
                <>
                  <Modal.Description>
                    ...
                    >
                      <Header style={{ alignSelf: 'center' }}>
                        Select Train Percentage: Default is 0.8
                      </Header>
                      <br />
                      <Input
                        style={{ color: 'black' }}
                        ...
                        onChange={event =>
                          console.log(
                            setnewTrainSize(Number(event.target.value))
                          )
                        }
                      />
                    </div>
                    ...
                    >
                      <Header style={{ alignSelf: 'center' }}>
                        Select Test Percentage: Default is 0.2
                      </Header>
                      <br />
                      <Input
                        onChange={event => {
                          setnewTestSize(Number(event.target.value));
                        }}
                  ...
                  <Modal.Description>
                    ...
                    <Select
                      onChange={event =>
                        console.log(setnewDistance(event.value))
                      }
                  ...
                  <Modal.Description>
                    ...
                    <Checkbox
                      onChange={(event, { checked }) =>
                        console.log(setnewReIndex(checked))
                      }
